...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '蝦Sir', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚，欢迎关注', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://n.haloosir.top/', // 网站地址
